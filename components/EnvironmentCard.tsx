            ...
            <div className="space-y-4">
                <div className="flex items-center">
                    ...
                    <div>
                        ...
                        <div className="font-bold text-xl text-gray-200">{temperature.toFixed(1)}°C</div>
                    </div>
                </div>
                <div className="flex items-center">
                    ...
                    <div>
                        ...
                        <div className="font-bold text-xl text-gray-200">{humidity}%</div>
                    </div>
                </div>
                 <div className="flex items-center">
                    ...
                    <div>
                        ...
                        <div className="font-bold text-xl text-gray-200">{light} <span className="text-sm font-normal">lux</span></div>
                    </div>
                </div>
            </div>
        </div>
